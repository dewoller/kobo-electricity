...
class MQTT:
    ...
    def on_connect(self, client, userdata, flags, rc):
        ...
        client.subscribe(self.searchTopic)
    ...
    def on_message(self, client, userdata, msg):
        ...
        event=['','']
        if len( msg.topic ) == len( self.baseTopic ):
            event = msg.payload.split( "|")
        else:
            event[0] = msg.topic[ (len(self.baseTopic )+1): ]  # strip out inTopic, leave the chunk at the end
            event[1] = msg.payload
